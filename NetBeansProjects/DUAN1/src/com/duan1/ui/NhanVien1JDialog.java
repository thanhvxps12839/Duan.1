 ...
 * @author admin
 */
public class NhanVien1JDialog extends javax.swing.JDialog {

    /**
     * Creates new form NhanVien1JDialog
     */
    public NhanVien1JDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.init();
    }
    ...
    private void initComponents() {
        ...
        rdo_qtv = new javax.swing.JRadioButton();
        ...
        buttonGroup2.add(rdo_qtv);
        rdo_qtv.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        rdo_qtv.setText("Quản trị viên");

        buttonGroup2.add(rdo_nhanvien);
        rdo_nhanvien.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        tbl_nhanvien.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã nhân viên", "Mật khẩu", "Tên nhân viên", "Giới tính", "Ngày sinh", "Điện thoại", "Địa chỉ", "Vai trò"
            }
        ));
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        .addComponent(txt_manhanvien, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addGroup(jPanel3Layout.createSequentialGroup()
                                                .addComponent(jLabel5)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                .addComponent(txt_matkhau, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE))
                                            .addGroup(jPanel3Layout.createSequentialGroup()
                                                .addComponent(jLabel3)
                                                .addGap(18, 18, 18)
                                                .addComponent(txt_tennv, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE))))
                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(jLabel4)
                                            .addComponent(jLabel2))
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(txt_gioitinh, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(ngaysinh, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)))))))
                    .addGroup(jPanel3Layout.createSequentialGroup()
    ...
    private void btn_saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_saveActionPerformed
        ...
        } else if (txt_tennv.getText().equals("")) {
        ...
        } else if (ngaysinh.getText().equals("")) {
            MsgBox.alert(this, "Ngày sinh Nhân Viên không được trống");
        } else if (txt_dienthoai.getText().equals("")) {
            MsgBox.alert(this, "Điện thoại Nhân Viên không được trống");
        } else if (txt_diachi.getText().equals(""))
            MsgBox.alert(this, "ĐỊa chỉ Nhân Viên không được trống");
        else
            this.insert();
    ...
    private void btn_printActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_printActionPerformed
        ...
        try {
            PdfWriter.getInstance(doc, new FileOutputStream(path + "" + manv + "&" + tennv + ".pdf"));
            doc.open();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NhanVien1JDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NhanVien1JDialog dialog = new NhanVien1JDialog(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JRadioButton rdo_qtv;
    ...
    void setForm(NhanVien nv) {
        ...
        txt_dienthoai.setText(nv.getDienthoai());
        txt_diachi.setText(nv.getDiachi());
        ngaysinh.setText(XDate.toString(nv.getNgaysinh(), "yyyy/MM/dd"));
        rdo_qtv.setSelected(nv.getVaiTro());
        rdo_nhanvien.setSelected(!nv.getVaiTro());
    }
    ...
    NhanVien getForm() {
        ...
        nv.setGioitinh(txt_gioitinh.getText());
        nv.setNgaysinh(XDate.toDate(ngaysinh.getText(), "yyyy/MM/dd"));
        //nv.setNgaysinh(new Date("2001/12/21"));
        nv.setDienthoai(txt_dienthoai.getText());
        nv.setDiachi(txt_diachi.getText());
        nv.setVaiTro(rdo_qtv.isSelected());
        return nv;
    }
